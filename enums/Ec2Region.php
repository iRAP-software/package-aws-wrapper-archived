...
class Ec2Region
{
    ...
    {
        $region = new Ec2Region('ec2.us-east-1.amazonaws.com');
        return $region;
    }
    ...
    {
        $region = new Ec2Region('ec2.us-west-1.amazonaws.com');
        return $region;
    }
    ...
    {
        $region = new Ec2Region('ec2.us-west-2.amazonaws.com');
        return $region;
    }
    ...
    {
        $region = new Ec2Region('ec2.eu-west-1.amazonaws.com');
        return $region;
    }
    ...
    {
        $region = new Ec2Region('ec2.ap-southeast-1.amazonaws.com');
        return $region;
    }
    ...
    {
        $region = new Ec2Region('ec2.ap-southeast-2.amazonaws.com');
        return $region;
    }
    ...
    {
        $region = new Ec2Region('ec2.ap-northeast-1.amazonaws.com');
        return $region;
    }
    ...
    {
        $region = new Ec2Region('ec2.us-gov-west-1.amazonaws.com');
        return $region;
    }
    
	public static function create_SA_E1()
    {
        $region = new Ec2Region('ec2.sa-east-1.amazonaws.com');
        return $region;
    }
